                    ...
                    for court in courts_in_zip:
                        ...
                        try:
                            ...
                            if scraped_data:
                                ...
                                court["page_source"] = scraped_data["page_title]
                                court["final_url"] = scraped_data["url"]
                                
                                # Extract chakra-link anchor tags
                                chakra_links = extract_chakra_links(scraped_data["page_source"])
                                court["chakra_links"] = chakra_links
                                print(f"  Found {len(chakra_links)} chakra-link anchor tags:")
